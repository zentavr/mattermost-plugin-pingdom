...
func (p *Plugin) handleWebhook(w http.ResponseWriter, r *http.Request, pingdomHookConfig pingdomHookConfig) {
	...
	for _, alert := range message.Alerts {
		fields = append(fields, ConvertPingdomToFields(pingdomHookConfig, alert, message.ExternalURL, message.Receiver)...)
	}
...
func ConvertPingdomToFields(config pingdomHookConfig, alert template.Alert, externalURL, receiver string) []*model.SlackAttachmentField {
	var fields []*model.SlackAttachmentField
